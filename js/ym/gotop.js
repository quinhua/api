...
function gotop1() {
    ...
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 20 20">
        ...
        $('#goToTop').css({"position": "fixed", "right":"40px","bottom":"40px","cursor":"pointer","width":`${gotop_width}`,"height":`${gotop_height}`,"border":`4px ${gotop_body_color} solid`,"border-radius":`${gotop_border_radius}`});
