...
const xuehua = ()=>{
     $("body").css({ "margin": "0", "padding": "0","background": "#000000" })
     .append($("<canvas id='canvasxuehua'></canvas>"));
     $("#canvasxuehua").css({ "width": "100vw", "height": "100vh", "position": "fixed", "top": "0", "left": "0", "z-index": "-100" });
     const ctx = canvasxuehua.getContext('2d');
    ...
    function resize() {
        width = canvasxuehua.width = window.innerWidth
        height = canvasxuehua.height = window.innerHeight
    }
