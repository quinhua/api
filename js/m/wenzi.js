//任选html标签(div、span、h1等)添加id命名为 headline
...
function wenzi() {
    $("body").css({ "margin": "0", "padding": "0"}).append($("<canvas id='canvaswz'></canvas>"));
    $("#canvaswz").css({
        "width": "100vw", "height": "100vh", "position": "fixed", "top": "-50px", "left": "0", "z-index": "-100",
        "display": "flex", "justify-content": "center", "align-items": "center"
    });
    $("#headline").css({ "opacity": "0", "font-size": "20", "height": "0" });

    ctx = canvaswz.getContext("2d"),
        particles = [],
        amount = 0,
        mouse = { x: -9999, y: -9999 },
        radius = 1,
    ...
    function initScene() {
        ww = canvaswz.width = window.innerWidth;
        wh = canvaswz.height = window.innerHeight;
        ctx.clearRect(0, 0, canvaswz.width, canvaswz.height);
